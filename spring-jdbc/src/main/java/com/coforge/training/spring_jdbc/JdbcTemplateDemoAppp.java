...
public class JdbcTemplateDemoAppp {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Press 1.Insert Cars\t 2.Update Cars \t 3.Delete Cars\t 4.View Cars\t"
                + " 5. View Cars byId \t 6. View All Cars-2");
        n=s.nextInt();
        ...
        case 1:    int status=dao.saveCar(new Cars("Fiat",20000));
                ...
                /* case 2: int status1=dao.updateCar(new Cars(3,10000)); // update car price
      ...
      case 5: Scanner scan=new Scanner(System.in);
        ...
        case 6: List<Cars> lst1=dao.getAllCars1();
                for(Cars c1:lst1)
                {
                    System.out.println(c1.getId()+" "+c1.getName()+" "+c1.getPrice());
                }
                    break;       
